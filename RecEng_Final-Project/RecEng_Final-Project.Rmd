...
Given the seperate nature, aim and construction of each recommendation engine, the model development section of this markdown is split into two parts, where section 2 contains the development for the groceries recommendation engine and section 3 contains the development for the movies recommendation engine.

Results and performance evaluations of the final prototypes are stated here below. A detailed methodology of how these models were selected can be found in sections (2.4) for grocery recommendations and (3.4) for movie recommendations.
